 ...
 */
class JECAnalysisHistsXCONE: public uhh2::Hists {
//class JECAnalysisHistsXCONE: public HistsBASE {
public:
    // use the same constructor arguments as Hists for forwarding:
    JECAnalysisHistsXCONE(uhh2::Context & ctx, const std::string & dirname);

    virtual void fill(const uhh2::Event & ev) override;
    void fill(const uhh2::Event & ev, const int rand);
    virtual ~JECAnalysisHistsXCONE();
