_main() 
{
    ...
    opts="--help --mode --dname --run -FP -FPeta -MP -OORP -MPd -OORPd -FCP -tCP -lFCP -aFCP -derThreshSi -derThreshSi_ptCheck -derThreshDi -derThreshDi_ptCheck -JEF -BC -D -E -DE -F -LP -aAP -aAPef -TEC -mu --muTrg --asym_cut --input --outSuffix -useHF -NPVEta -mon"
