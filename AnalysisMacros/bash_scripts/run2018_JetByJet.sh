...
./main --run C -F -CPPUjets --inputMC $path_Gl/uhh2.AnalysisModuleRunner.MC.QCD_HT_2018_AK4CHS.root --outSuffix _Flat2018Pythi8MCakaold_MadGraphDATAakanew_noJERsf --input $path_Gl/uhh2.AnalysisModuleRunner.MC.QCD_Flat2018_pythia8_2018_AK4CHS.root --outSuffix _MadGraph_noJERsf  --Generator madgraph
