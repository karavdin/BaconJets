...
using namespace std;
  ...
  public:
    ...
    void Pt_Extrapolation_Alternative_CorrectFormulae(bool mpfMethod = true, double kfsr_fitrange = 5.19, bool useCombinedkSFR=false);
    ...
    void FullCycle_CorrectFormulae(double kfsr_fitrange=5.19, bool useCombinedkSFR=false);
